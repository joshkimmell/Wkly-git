...
// import { fetchGoals, fetchAllGoals, indexDataByScope, getPagesFromIndexedData, filterGoalsByWeek, filterGoalsByMonth, filterGoalsByYear, addGoal, deleteGoal, updateGoal, getWeekStartDate, setSummary, saveSummary } from '@utils/functions';
...
//   useEffect(() => {
//     const fetchAndIndexGoals = async () => {
//       try {
//         const allGoals = await fetchAllGoals(); // Fetch all goals
//         setGoals(allGoals);

//         const indexed = indexDataByScope(allGoals, scope) as Record<string, Goal[]>;
//         setIndexedGoals(indexed);

//         const pages = getPagesFromIndexedData(indexed);
//         setPages(pages);
...
//         }
//       } catch (error) {
//         console.error('Error fetching and indexing goals:', error);
//       }
//     };
...
//         <h1 className="text-2xl font-bold text-gray-90 block sm:hidden">{scope.toUpperCase()}ly goals</h1>
//       </div>
